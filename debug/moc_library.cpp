...
QT_MOC_LITERAL(4, 33, 8)
    ...
    "Library\0musicAdded\0\0musicDeleted\0"
    "addMusic"
};
...
void Library::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->musicAdded(); break;
        case 1: _t->musicDeleted(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Library::musicAdded)) {
                *result = 0;
            }
        }
        {
            typedef void (Library::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Library::musicDeleted)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Library::musicAdded()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void Library::musicDeleted()
{
